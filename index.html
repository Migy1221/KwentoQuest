...
<head>
    ...
    <style>
        body {
            background-image: url('http://localhost/KwentoQuest/img/MainBG.png'); /* Replace with your accessible image path */
...
<body>
    <div class="container">
        <div class="card verification-card">
            ...
            <form id="ageVerificationForm" action="verify_age.php" method="post">
                <div class="row mb-3">
                    <div class="col">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            ageVerificationForm.addEventListener('submit', function (event) {
                ...
                var formData = new FormData(ageVerificationForm);
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        window.location.href = 'http://localhost/KwentoQuest/home.php'; // Redirect to your homepage
                    }
                })
                .catch(error => {
